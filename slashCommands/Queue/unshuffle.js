...
module.exports = {
	...
	description: "UN-Shuffles (Phát ngẫu nhiên) Hàng đợi", //the command description for Slash Command Overview
	cooldown: 10,
			...
			try {
				...
				interaction.reply({
					embeds: [new MessageEmbed()
					  .setColor(ee.color)
					  .setTimestamp()
					  .setTitle(`🔀 **__UN__ - Suffled ${newQueue.songs.length} bài hát!**`)
