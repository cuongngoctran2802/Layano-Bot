...
module.exports = {
	...
	description: "Shuffles (Phát ngẫu nhiên) hàng chờ", //the command description for Slash Command Overview
	cooldown: 10,
			...
			try {
				...
				interaction.reply({
					embeds: [new MessageEmbed()
					  .setColor(ee.color)
					  .setTimestamp()
					  .setTitle(`🔀 **Phát ngẫu nhiên ${newQueue.songs.length} bài hát!**`)
